...
const StyledTitle = styled.h2`
  ...
  background: linear-gradient(
    90deg,
    ${colors.lightestSlate} 0%,
    ${colors.green} 25%,
    ${colors.white} 50%,
    ${colors.green} 75%,
    ${colors.lightestSlate} 100%
  );
...
const StyledNowBadge = styled.div`
  display: inline-flex;
  align-items: center;
  gap: 10px;
  margin-top: 30px;
...
const StyledLiveDot = styled.span`
  width: 8px;
  height: 8px;
  border-radius: 50%;
...
const StyledNowText = styled.span`
  font-family: ${fonts.SFMono};
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      tl.to($$('.wn'), {
        ...
        .to(
          $$('.wl'),
          { strokeDashoffset: 0, opacity: 0.6, duration: 0.5, stagger: 0.04, ease: 'power2.out' },
          '-=0.2',
        )
        ...
        .to(
          $$('.wp'),
          { opacity: 0.3, scale: 0.8, duration: 0.3, stagger: 0.1, ease: 'power2.in' },
          '+=0.2',
        )
  ...
  return (
    ...
    >
      ...
      <g id="agentStage">
        ...
        <path
          className="wl"
          d="M100,185 C130,185 140,120 160,120"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M100,195 C130,195 140,250 160,250"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M230,120 C265,120 275,160 300,160"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M230,245 C265,245 275,165 300,165"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M230,255 C260,255 280,250 300,250"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M190,140 C190,170 190,210 190,230"
          fill="none"
        ...
        <path
          className="wl"
          d="M370,160 C395,160 410,185 420,190"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
        ...
        <path
          className="wl"
          d="M370,250 C395,250 410,205 420,200"
          fill="none"
          stroke="#ffd700"
          strokeWidth="1.2"
          strokeDasharray="200"
  ...
  const fourHalf = () => (
    <div style={{ transitionDelay: '450ms' }}>
      <StyledNowBadge>
        <StyledLiveDot />
        <StyledNowText>
          Currently building <span>Veronica</span> — Agentic AI Assistant
        </StyledNowText>
      </StyledNowBadge>
    </div>
  );
